...
package Chefcito::Chef::Container;
...
Chefcito::Chef::Container - Internal module used by Chefcito::Chef
...
This is the Chefcito::Chef::Container constructor. Creates a new
Chefcito::Chef::Container object. All arguments are treated as key/value pairs for
object attributes.
...
This method implements the 'put' command. Please refer to L<Chefcito::Chef> for
details.
...
This method implements the 'fold' command. Please refer to L<Chefcito::Chef> for
details.
...
This method implements the 'add' command. Please refer to L<Chefcito::Chef> for
details.
...
This method implements the 'remove' command. Please refer to L<Chefcito::Chef> for
details.
...
This method implements the 'combine' command. Please refer to L<Chefcito::Chef> for
details.
...
This method implements the 'divide' command. Please refer to L<Chefcito::Chef> for
details.
...
This method takes a number of Chefcito::Chef::Ingredient objects as arguments and
creates and 'puts' the sum of the ingredients.

Please refer to L<Chefcito::Chef> for details.
...
This method implements the 'compare' command. Please refer to L<Chefcito::Chef> for
details.
...
sub compare {
   ...
   croak "Invalid operation on empty container: compare."
     unless @{$self->{contents}};

        #primer valor de la pila == ingrediente
     if($self->{contents}->[-1]->value() == $ingredient->value()){
      return 1;
     }
     else{
       return 0;
...
This method implements the 'mix' command. Please refer to L<Chefcito::Chef> for
details.
...
This method implements the 'clean' command. Please refer to L<Chefcito::Chef> for
details.
...
This method implements the 'pour' command. Please refer to L<Chefcito::Chef> for
details.
