...
package Chefcito::Chef::Ingredient;
...
Chefcito::Chef::Ingredient - Internal module used by Chefcito::Chef
...
Chefcito::Chef::Ingredient constructor. Takes key/value pairs as argument which
